...
La frequenza ciclotronica dei protoni è definita da:
...
- \( q \) è la carica del protone  
- \( B \) è l’intensità del campo magnetico  
- \( m \) è la massa del protone  

Questa frequenza determina il comportamento rotazionale dei protoni all’interno del reattore MCPD.

## Interazione con il Campo Pulsato

Il sistema MCPD applica un campo magnetico pulsato che modifica la traiettoria dei protoni, aumentando la loro energia cinetica e contribuendo alla generazione della spinta.

L’onda pulsata produce:
